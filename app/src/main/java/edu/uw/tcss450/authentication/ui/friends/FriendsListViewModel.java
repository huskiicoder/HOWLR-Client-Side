...
public class FriendsListViewModel extends AndroidViewModel {
    ...
    private void handleResult(final JSONObject result) {
        ...
        try {
            ...
            if (root.has(getString.apply(R.string.keys_json_friends_response))) {
                JSONObject response =
                        root.getJSONObject(getString.apply(
                                R.string.keys_json_friends_response));
                if (response.has(getString.apply(R.string.keys_json_friends_request))) {
                    JSONArray request = response.getJSONArray(
                    ...
                    JSONArray friends = root.getJSONArray(getString.apply(R.string.keys_json_friends));
    ...
    public void connectAddFriendsPost(String username) {
        String url = "https://howlr-server-side.herokuapp.com/contacts";
