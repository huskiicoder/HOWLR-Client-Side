...
import edu.uw.tcss450.authentication.databinding.FragmentFriendsRequestCardBinding;
...
public class FriendsRequestRecyclerViewAdapter
    ...
    public class FriendsRequestViewHolder extends RecyclerView.ViewHolder {
        ...
        private void acceptRequest(final FriendsRequestViewHolder view, Friends friends) {
            ...
            toast.show();
            Navigation.findNavController(mView).navigate(FriendsRequestFragmentDirections.actionFriendsRequestFragmentToNavigationFriendsListFragment());
        }
